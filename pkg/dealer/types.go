...
func (d DealerResponse) String() string {
	fields := []string{
		d.ID,
		d.Name,
		d.Address.Type,
		...
		d.Address.Zipcode,
		d.PhoneNumber,
		d.ServicePhoneNumber,
		d.FaxNumber,
	}

	fields = append(fields, d.Types...)
...
type TrackingDataAddress struct {
...
type TrackingData struct {
	Address       TrackingDataAddress `json:"address"`
	Certified     bool                `json:"certified"`
